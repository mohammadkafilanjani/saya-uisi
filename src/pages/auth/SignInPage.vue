          ...
          <div class="row justify-center">
            <div class="col-md-10 col-sm-10 col-xs-11">
              <q-card class="my-card" bordered flat>
                <q-card-section>
                  <div class="text-h5">SAYA UISI</div>
                  <div class="text-h6">Masuk</div>
                ...
                <q-card-section>
                  <q-form @submit="onSubmit" class="q-gutter-md">
                    ...
                    <div class="text-center">
                      <q-btn icon="fa-brands fa-google" flat class="full-width" @click="signInWithGoogle">
                        <span class="q-ml-md">Masuk Dengan Google</span>
                      </q-btn>
                    </div>
                    <div class="text-center">
...
const signInWithGoogle = () => {
  window.location.href = `${baseURL}signin/google`
};
